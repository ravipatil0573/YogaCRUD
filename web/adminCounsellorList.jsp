...
<html>
    <head>
        ...
        <style>
            body {
                background-image: url("img/y10.jpg");
                    ...
                    <div class="table100 ver3 m-b-110">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from Counsellor where fname like '%" + query + "%' or lname like '%" + query + "%' ";
                                } else {
                                ...
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column5">
                                            <a href="updateCounsellor.jsp?mob=<%=mob%>">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                           <a href="deleteCounsellor.jsp?mob=<%=mob%>">Delete</a>                          
                                        </td>
                                    </tr>
                                </tbody>
                                <%
