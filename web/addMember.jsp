    ...
    <body>
        ...
        <div class="container-contact100">
            ...
            <div class="wrap-contact100">
                <div class="contact100-form-title" style="background-image: url(gym7.jpg);">
                    <span class="contact100-form-title-1">
                        Member Registration Form
                    </span>				
                </div>

                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/AddMember" method="post">
