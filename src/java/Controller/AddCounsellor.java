...
PrintWriter pw = response.getWriter();
        try {
            ...
            PreparedStatement pst = con.prepareStatement("insert into Counsellor values(?,?,?,?)");
            ...
            if (i > 0) {
                ...
                pw.println("window.location.href = \"AddCounsellor.jsp\";");
                pw.println("</script>");
                //RequestDispatcher rd = request.getRequestDispatcher("AddCounsellor.jsp");
                //rd.forward(request, response);
            }
